...
| PvE Progression | clears joueur, historique de run, meilleur clear, pourcentage de contenu clear, lecture par PhaseManager, score groupe vide, rankings national/mondial, score d'activité guilde vide |
