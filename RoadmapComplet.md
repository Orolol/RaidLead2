...
> - ✅ **Tests automatisés** : harnais maison `res://tests/` (52 assertions, 100 % vertes) lançable en headless (`tests/run_tests.ps1`).
...
- ✅ **Suites** : GameTime, Item/Equipment, SimulatedPlayer (stress/burnout), BalanceManager, AdvisorManager, SaveManager (round-trip), AIGuild, PvE Progression, ActivityManager, PhaseManager — **52 assertions, 100 % vertes**
...
- **Milestone 6** : 95% ✅ *(Polish : conseiller adaptatif, dashboard de stats, auto-sauvegarde + backup, équilibrage adaptatif BalanceManager, harnais de tests automatisés 52/52 ; calibrage fin et playtests externes restants)*
...
- **Tests** : suite automatisée étendue à 52 assertions, validée avec Godot 4.6.2.
